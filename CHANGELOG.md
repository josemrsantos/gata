...
Corrects stale _COST_PER_M rates for Claude/Gemini and swaps default Grok
models off grok-3/grok-3-mini after confirming via a live API check that both
are retired and now silently redirect to grok-4.3 — the same model, which had
collapsed the aggregator/panelist distinction from Spec 029. Also replaces
gemini-2.0-flash (shut down 2026-06-01) in the last-resort Gemini fallback.
Amends constitution to v1.1 (§1, §6) and bumps to v1.21.0.

Co-Authored-By: Claude Sonnet 5 <noreply@anthropic.com> ([`f48547a`](https://github.com/josemrsantos/gata/commit/f48547a29eab6df7966c2ea1a6039af5d6c5833d))
...
* Create LICENSE ([`fdc8b03`](https://github.com/josemrsantos/gata/commit/fdc8b03f5b1326891a4ca0657024e6eeecc3c21f))
